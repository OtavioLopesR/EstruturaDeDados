package linkeddequedao.dao.repository;

import java.util.NoSuchElementException;

/**
 * Implementação de uma fila com dupla terminação dinâmica duplamente encadeada
 * genérica. Esta classe implementa uma fila com dupla terminação que pode
 * armazenar elementos de qualquer tipo, utilizando uma estrutura de nós
...
public class LinkedDEQue<T> implements DEQueable<T> {
    ...
    /**
     * Retorna uma representação em string da fila do início para o final. Os
     * elementos são separados por vírgula e delimitados por colchetes.
     *
    ...
    /**
     * Retorna uma representação em string da fila do fim para o início. Os
     * elementos são separados por vírgula e delimitados por colchetes.
     *
