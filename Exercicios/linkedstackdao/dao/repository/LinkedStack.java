package linkedstackdao.dao.repository;

import java.util.NoSuchElementException;

/**
 * Implementação de uma pilha dinâmica duplamente encadeada genérica. Esta
 * classe implementa uma pilha que pode armazenar elementos de qualquer tipo,
...
public class LinkedStack<T> implements Stackable<T> {
    ...
    /**
     * Retorna uma representação em string da pilha. Os elementos são separados
     * por vírgula e delimitados por colchetes. O elemento do topo será o último
     * elemento na string.
     *
