package linkedlistdao.dao.repository;

import linkedlistdao.dao.repository.OverflowException;
import linkedlistdao.dao.repository.UnderflowException;

/**
 * Implementação de uma lista dinâmica duplamente encadeada genérica. Esta
 * classe implementa uma lista que pode armazenar elementos de qualquer tipo,
...
public class LinkedList<T> implements Listable<T> {
    ...
    /**
     * Retorna uma representação em string da lista. Os elementos são separados
     * por vírgula e delimitados por colchetes.
     *
    ...
    /**
     * Método auxiliar para obter um nó em uma posição específica, a partir do
     * início da ED.
     *
